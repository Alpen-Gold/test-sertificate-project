...
import popular_men_1 from "../../../assets/img/men_card_1.png";
import popular_men_2 from "../../../assets/img/men_card_2.png";
import popular_men_3 from "../../../assets/img/men_card_3.png";
import popular_men_4 from "../../../assets/img/men_card_4.png";
// img_men_page
      ...
      <Box className="main_popular_card_page">
        {cards.map((card, index) => (
          <Box sx={{ width: card_width }} key={index}>
            <Box sx={{ height: "88% !important" }} position={"relative"}>
...
export default ClothingSuggest;
